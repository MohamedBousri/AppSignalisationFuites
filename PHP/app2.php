...
.topnav a.active {
    ...
    <body style="background-color:#08088A" onLoad="load();">
        ...
        <img src="logo.png" height="100px" width="100px" style="margin-left:65em;margin-top:1em;"/>
            ...
            <a class="i" href="app.php" title="Voir que les signalisations non lu "><img src="icon.png" height="50px" width="43px"></a>
        </div>
	...
	// En cas d'erreur, on affiche un message et on arrête tout
        ...
        $reponse3 = $bdd->query('SELECT * FROM assignissment ');
        $reponse2 = $bdd->query('SELECT * FROM fuite ');
