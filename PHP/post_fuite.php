...
if (isset($_POST['code']) && isset($_POST['nom']) && isset($_POST['telephone'])
     ...
     && isset($_POST['latitude']) && isset($_POST['presentation']) && isset($_POST['detail'])  && isset($_POST['image']) && isset($_POST['status']) ) {
   ...
   // require_once __DIR__ . '/db_connect.php';
    ...
    $result1 = mysqli_query($con,"INSERT INTO fuite(adresse, type, longitude,latitude,presentation,clientcode,detail,image,status) 
                                            VALUES('$adresse', '$type', '$longitude','$latitude','$presentation','$code','$detail','$image','$status')");
